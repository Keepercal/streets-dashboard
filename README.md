...
### Added
- Filtering!! When a feature is selected, you can filter the points displayed on the map depending on the tags, such as whether a point is missing a particular tag.
